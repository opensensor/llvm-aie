...
static LegalityPredicate isValidVectorAIEPS(const unsigned TypeIdx) {
  return [=](const LegalityQuery &Query) {
...
static const std::initializer_list<LLT> AIE2PSVectorTypes = {
    /* Begin 32-bit types*/
    V4S8, V2S16,
    /* Begin 256-bit types */
    V8S32, V16S16, V32S8,
...
static const std::initializer_list<LLT> AIE2PSAccumulatorTypes = {
    /* Begin 256-bit types */
    AccV8S32, AccV4S64,
    /* Begin 512-bit types */
    AccV1632, AccV8S64,
...
AIE2PSLegalizerInfo::AIE2PSLegalizerInfo(const AIE2PSSubtarget &ST)
    : AIEHelper(ST) {
  ...
  getActionDefinitionsBuilder({G_IMPLICIT_DEF, G_FREEZE})
      ...
      .legalFor(AIE2PSVectorTypes)
      .legalFor(AIE2PSAccumulatorTypes)
      .legalFor({AccV2S1024})
  ...
  getActionDefinitionsBuilder(G_EXTRACT_VECTOR_ELT)
      ...
      .customIf(typeInSet(1, AIE2PSVectorTypes))
      .customIf(typeInSet(1, AIE2PSAccumulatorTypes))
      .customIf([=](const LegalityQuery &Query) {
  ...
  getActionDefinitionsBuilder(G_INSERT_VECTOR_ELT)
      ...
      // Custom legalize resulting vector types >= 256-bit
      .customIf(typeInSet(0, AIE2PSVectorTypes))
      .customIf(typeInSet(0, AIE2PSAccumulatorTypes));
  ...
  const LegalityPredicate IsNotValidDestinationVector =
      negatePredicate(isValidVectorAIEPS(0));
  ...
  getActionDefinitionsBuilder(G_CONCAT_VECTORS)
      .customIf([=](const LegalityQuery &Query) {
        ...
        // (128-bit vectors are not sub-registers of 256-bit vectors in AIE2PS)
...
bool AIE2PSLegalizerInfo::legalizeCustom(
...
bool AIE2PSLegalizerInfo::legalizeIntrinsic(LegalizerHelper &Helper,
